...
@section('content_header')
    <h2>Crear una visación de plano</h2>
@stop

@section('content')
    <div class="card">
        <div class="card-body">
            {!! 'Form'::open(['route' => 'admin.vplanos.store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
            ...
            {!! Form::submit('Crear visación de plano', ['class' =>'btn btn-primary']) !!}
