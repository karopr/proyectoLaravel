...
@section('content_header')
    <h2>Crear un plano de bienes nacionales</h2>
@stop

@section('content')
    <div class="card">
        <div class="card-body">
            {!! 'Form'::open(['route' => 'admin.pbienes.store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
            ...
            {!! Form::submit('Crear plano', ['class' =>'btn btn-primary']) !!}
