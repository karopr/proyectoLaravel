...
<div class="card">
    <div class="card-body">
        {!! Form::model($pago,['route' => ['admin.pagos.update', $pago], 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
        ...
        {!! Form::submit('Actualizar pago', ['class' =>'btn btn-primary']) !!}
