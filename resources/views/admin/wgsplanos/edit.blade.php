...
@section('title','Editar plano WGS84')

@section('content_header')
    <h2>Editar un plano WGS84</h2>
@stop

@section('content')
<div class="card">
    <div class="card-body">
        {!! Form::model($wgsplano,['route' => ['admin.wgsplanos.update', $wgsplano], 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
