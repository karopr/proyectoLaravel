...
@section('content_header')
    <h2>Crear una ficha técnica de inspección</h2>
@stop

@section('content')
    <div class="card">
        <div class="card-body">
            {!! 'Form'::open(['route' => 'admin.fichas.store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
            ...
            {!! Form::submit('Crear ficha', ['class' =>'btn btn-primary']) !!}
