...
@section('title','Editar planos PSAD56')

@section('content_header')
    <h2>Editar un plano PSAD56</h2>
@stop

@section('content')
<div class="card">
    <div class="card-body">
        {!! Form::model($psadplano,['route' => ['admin.psadplanos.update', $psadplano], 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
